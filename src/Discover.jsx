...
const WA_NUMBERS  = { default: WA.meta,    google: WA.google,    meta: WA.meta,    tiktok: WA.tiktok    };
const WA_MESSAGES = { default: WA_MSG.meta, google: WA_MSG.google, meta: WA_MSG.meta, tiktok: WA_MSG.tiktok };
// ──────────────────────────────────────────────────────────────────────────
...
const Home3 = () => {
  ...
  const [waNumber, setWaNumber] = useState(WA_NUMBERS.meta);
  const [waMessage, setWaMessage] = useState(WA_MESSAGES.meta);
  ...
  const handleHeroFormSubmit = async () => {
    ...
    const isPhoneLong = phoneVal.length > 15;
    const isPhoneValid = isPhoneLong || (phoneVal.length > 3 && isValidPhoneNumber(phoneVal));
...
<a href="#tours" className="hero-cta hero-cta--outline">Explore Tours</a>
      ...
      <div className="hero-ratings-bar">
        ...
        <div className="hero-rating-col hero-rating-col--total">
          <span className="hero-rating-score hero-rating-score--big"><AnimatedCounter target={10629} duration={2000} formatter={(n) => n.toLocaleString('en-US')} /></span>
...
<section className="sku-section section-padding" id="tours">
  <div className="container">
    ...
    <div className="sku-grid sku-grid--minimal">
      {/* Shared Tour */}
      <a href={utmUrl("https://bluuu.tours/new/shared")} id="shared-tour-card" className="sku-minimal animate-in">
      ...
      {/* Private Charter */}
      <a href={utmUrl("https://bluuu.tours/new/private")} id="private-charter-card" className="sku-minimal sku-minimal--delay animate-in">
