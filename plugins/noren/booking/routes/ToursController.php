...
class ToursController extends Controller
{
     ...
     */
    public function getTours($members = 1, $typeId = null, $categoryId = null, $date = null)
    {
        ...
        [$adults, $kids, $children, $typeId, $categoryId, $date] = [
            $input['adults'],
            $input['kids'],
            $input['children'],
            $input['type'],
        ...
        $tours = $this->getToursQuery($typeId, $categoryId);
        if (!$tours->count()) {
    ...
    {
        $input = Input::only('adults', 'kids', 'children', 'type', 'category', 'date');
    ...
    // --------------------------------------------------
    private function getToursQuery($typeId, $categoryId)
    {
        $query = Tours::with([
            'types',
            'boat.closeddates',
