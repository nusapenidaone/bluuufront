    ...
    template:`
        <div class="p-xl-1 p-4 border-black-10 bg50 rounded-1 mb-3 bg-white">
            <div class="d-flex fz-12 pointer">
                ...
                <div v-if="order.payStep>2">
                    <div class="fz-09 c-950 fw-600 tdu c-blue-hover" v-on:click="order.payStep=2">Edit</div>
                </div>
            </div>
            ...
            <Transition>
                ...
                <div v-else>
                       ...
                       <div class="h-1 bg-black-10 my-3"></div>
                    <div class="d-flex align-items-center">
                        <img alt="card" height="20" v-bind:src="selectedMethod.icon">
                        <div class="ms-2 c-500 c-950 fz-12 fw-600" >{{selectedMethod.name}}</div>
                    </div>
