const ProgramSelector={
                                ...
                                <div class="col-xl-10 col-9">
                                    <div class="h-100 d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div v-if="programs.length>1" class="radio-button fz-15" v-bind:class="{ active : order.selectedProgramId==program.id }"></div>
                                        </div>
    ...
    data(){
        return{
            program: null,
            show: true,
            active: this.order.selectedProgramId,
        }
    },
    methods:{
        ...
        save(program){
            if(program.id==this.order.selectedProgramId) return false;
            this.order.selectedProgramId=program.id;
