const CoverSelector = {
                                ...
                                <div class="col-xl-10 col-9">
                                    <div class="h-100 d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="radio-button fz-15" v-bind:class="{ active : order.selectedCoverId==cover.id }"></div>
                                        </div>
                                ...
                                <div class="col-xl-10 col-9">
                                    <div class="h-100 d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="radio-button fz-15" v-bind:class="{ active : order.selectedCoverId==null }"></div>
                                        </div>
    ...
    data() {
        return {
            show: false,
            active: this.order.selectedCoverId,
            cover: null,
        };
    },
    methods: {
        ...
        save(cover) {
            ...
            if(cover==null){
                this.order.selectedCoverId=null;
                this.active=null;
                this.$emit('close', ' Coverage removed');
            }else{
                if(cover.id==this.order.selectedCoverId) return false;
                this.order.selectedCoverId=cover.id;
