...
const RestaurantSelector= {
                                ...
                                <div class="col-xl-10 col-9">
                                    <div class="h-100 d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div v-if="restaurants.length>1" class="radio-button fz-15" v-bind:class="{ active : order.restaurant_id==restaurant.id }"></div>
                                        </div>
    ...
    data(){
        return{
            restaurant: null,
            show: false,
            active: this.order.restaurant_id,
        }
    },
    methods:{
        ...
        save(restaurant){
            if(restaurant.id==this.order.restaurant_id) return false;
            this.order.restaurant_id=restaurant.id;
