const SearchFilter={
        ...
        <div class="position-relative">
            <form class="filter border-black-10 rounded-1 bg-white" v-on:submit.prevent="save">
                <div class="row gx-0 align-items-center justify-content-between">
                    <div class="col-xl col-4 position-relative">
                        <div class="px-xl-4 py-xl-3 ps-4 px-3 py-2 rounded-1 pointer" v-on:click="dropdown=1">
                            <div class="fz-09 c-500 lh-1">Tour Type</div>
                            <div class="fw-600 text-nowrap text-limit"><span v-if="selectedCategory==null">All Tours</span><span v-else v-text="selectedCategory.name"></span></div>
                        </div>
                    </div>
                    ...
                    <div class="col position-relative">
                        <div class="px-xl-4 py-xl-3 px-2 py-2 rounded-1 pointer" v-on:click="dropdown=3">
                            ...
                            <div class="fw-600 text-nowrap" v-text="membersView"></div>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="p-2">
                    ...
                    <div class="row" >
                        <div class="col-xl-6 order-first" >
                            <div class="shadow dropdown  z-2 type-selector bg-white rounded-1 p-3 border-black-10">
                                <div class="p-3 d-flex align-items-center rounded-1 bg-100-hover pointer" :class="selectedCategory == null && 'bg-100'" v-on:click="selectedCategory=null, dropdown=false">
                                    <span class="ms-2 fw-600">All Tours</span>
                                </div>
                                
                                <template v-for="cat in category" :key="cat.id">
                                    
                                    <div class="p-3 d-flex align-items-center rounded-1 bg-100-hover pointer" :class="selectedCategory == cat && 'bg-100'" v-on:click="selectedCategory=cat, dropdown=false"><span class="fw-600">{{cat.name}}</span>
                                    </div>
                                </template>
                            </div>
                        </div>
                            ...
                            <div class="shadow dropdown z-2 members-selector bg-white rounded-1 p-3 border-black-10">
                                ...
                                <div class="d-flex p-3">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="fz-08 c-500">8-13 years old <br>
    ...
    data(){
        return{
            ...
            selectedCategory: this.order.selectedCategory
        }
    },
    mounted(){
        this.showCalendar();
    ...
    methods:{
        save() {
            this.order.selectedCategory=this.selectedCategory;
