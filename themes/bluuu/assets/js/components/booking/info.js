    ...
    template:`
        ...
        <div class="bg-white rounded-1 shadow p-4" id="check" style="scroll-margin-top: 6rem">
            ...
            <template v-if="order.travelDate">
                ...
                <div class="d-flex justify-content-end pb-2 text-end border-dashed-bottom" v-if="showPromocode==false">
                    <div class="c-950 pointer py-2 tdu" v-on:click="showPromocode=true">Have a promo code?</div>
                </div>
                </template>
        ...
        <Teleport to="body">
            <div class="d-xl-none d-block position-sticky bottom z-3 bg-white shadow py-3" v-if="order.step!=3">
