...
const TransferSelector={
                        ...
                        <div v-for="transfer in transfers" v-bind:key="transfer.id" class="pointer">
                            ...
                            <div class="row gx-xl-4 gx-3" v-on:click="save(transfer)">
                                <div class="col-xl-2 col-3">
                                    <img src="/themes/bluuu/assets/img/transfer.webp" alt="" class="w-100 ratio-1x1 rounded-1 img">
                                </div>
                                <div class="col-xl-10 col-9">
                                    <div class="h-100 d-flex flex-column">
                                        <div class="d-flex">
                                            ...
                                            <div class="radio-button fz-15" v-bind:class="{ active : order.transfer_id==transfer.id }"></div>
                                        </div>
                                        <div class="fz-09 c-500 mt-2 pe-xl-5" v-html="transfer.short_description"></div>
                                        <div class="mt-2"><span class="fz-09 tdu c-950 tdu" v-on:click.stop="showTransfer(transfer)">How it works</span></div>
                                    </div>
                                </div>
                            </div>


                        <div v-if="transfer.id==1 && order.transfer_id==1">
                            
                            <div class="mt-3">
                                <div class="mb-2 c-500 fz-09">Pick Up Address</div>
                                <input class="input" type="text" v-model="order.pickup_address" placeholder="Enter Pick Up Address">
                            </div>
                        </div>
                        <div v-if="transfer.id==2 && order.transfer_id==2">
                            ...
                            <div class="mt-3">
                                ...
                                <input class="input mb-3" type="text" v-model="order.dropoff_address" placeholder="Enter Drop Off Address" v-if="same==false">
                                ...
                                <div class="col-xl-10 col-9">
                                    <div class="h-100 d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="radio-button fz-15" v-bind:class="{ active : order.transfer_id==null }"></div>
                                        </div>
    ...
    data() {
        return {
            ...
            show: false,
            active: this.order.transfer_id,
            same: false,
            pickupAddress: this.order.pickup_address,
            dropoffAddress: this.order.dropoff_address,
            select: null,
            transfer: null,
        };
    },
    ...
    methods: {
        checkSame(){
            if(this.same) {
                this.order.dropoff_address=this.order.pickup_address
            }
        },
        ...
        save(transfer) {
            ...
            if(transfer==null){
                ...
                this.order.transfer_id=null;
                this.active=null;
                this.$emit('close', ' Transfer removed');
            }else{

                if(transfer.id==this.order.transfer_id) return false;
                this.order.transfer_id=transfer.id;
